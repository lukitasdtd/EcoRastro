...
export default function LeafletMap() {
    ...
    useEffect(() => {
        ...
        if (!apiKey) {
            console.error("MapTiler API key no encontrada. Asegúrate de crear un archivo .env.local con NEXT_PUBLIC_MAPTILER_API_KEY");
            toast({
                variant: 'destructive',
                title: 'Error de configuración del mapa',
                description: 'Falta la clave de API para el servicio de mapas.',
            });
            return; // No inicializar el mapa si no hay clave
        }
        ...
        Promise.all([
            ...
            // Añade la capa de teselas de MapTiler OMT usando la clave de entorno.
