...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center bg-background">
      <header className="w-full overflow-hidden bg-muted/30">
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="max-w-xl mx-auto md:mx-0 text-lg md:text-xl text-foreground/70 mb-8">
            ...
            <div className="relative h-[350px] md:h-[450px]">
                {heroHuerta && (
                     <div className="absolute w-[60%] h-[70%] top-0 left-0 rounded-tl-[3rem] rounded-br-[3rem] overflow-hidden shadow-2xl transform -rotate-6 transition-transform hover:scale-105">
                        <Image
                ...
                {heroMascotas && (
                     <div className="absolute w-[60%] h-[70%] bottom-0 right-0 rounded-tr-[3rem] rounded-bl-[3rem] overflow-hidden shadow-2xl transform rotate-3 transition-transform hover:scale-105">
                         <Image
